 ...
 * @param queryFunction  A pointer to the vool(char*) query function
 ...
 * @param writeFunction  A pointer to the int(char*, char*)write function
 ...
 * @param readFunction   A pointer to the int(char*) get character
 ...
 *                       by logical name.
 * @param unreadFunction A pointer to the int(int,char*)unget character
 ...
 * @return               true if the router was added; false otherwise.
 */
 ...
 * @return            true if the logical name is recognized, false otherwise
 */
