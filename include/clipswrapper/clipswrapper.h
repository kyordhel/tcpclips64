...
/* ** ***************************************************************
*
* [Deprecated] DefineFunction-related
*
** ** **************************************************************/
 ...
 */
[[deprecated("clips::argCountCheck uses a CLIPS6.0 function that was removed and is no longer available in CLIPS6.4. "\
"The function is provided for backwards compatibility but may be buggy and is no longer being maintained. "\
"Use clips::udf::argumentCount instead.")]]
bool argCountCheck(
 ...
 */
[[deprecated("clips::defineFunction uses CLIPS6.0 functions that were removed and are no longer available in CLIPS6.4. "\
"The function is provided for backwards compatibility but may be buggy and is no longer being maintained. "\
"Use clips::udf::addFunction instead.")]]
 ...
 */
[[deprecated("clips::returnArgCount uses a CLIPS6.0 function that was removed and is no longer available in CLIPS6.4. "\
"The function is provided for backwards compatibility but may be buggy and is no longer being maintained. "\
"Use clips::udf::argumentCount instead.")]]
int returnArgCount();
 ...
 */
[[deprecated("clips::returnDouble uses a CLIPS6.0 function that was removed and is no longer available in CLIPS6.4. "\
"The function is provided for backwards compatibility but may be buggy and is no longer being maintained. "\
"Use clips::udf::nthArgument instead.")]]
 ...
 * @return        The string representation of the argument
 */
[[deprecated("clips::returnInt uses a CLIPS6.0 function that was removed and is no longer available in CLIPS6.4. "\
"The function is provided for backwards compatibility but may be buggy and is no longer being maintained. "\
"Use clips::udf::nthArgument instead.")]]
 ...
 * @return        The string representation of the argument
 */
[[deprecated("clips::returnLexeme uses a CLIPS6.0 function that was removed and is no longer available in CLIPS6.4. "\
"The function is provided for backwards compatibility but may be buggy and is no longer being maintained. "\
"Use clips::udf::nthArgument instead.")]]
 ...
 * @return        The string representation of the argument
 */
[[deprecated("clips::returnLong uses a CLIPS6.0 function that was removed and is no longer available in CLIPS6.4. "\
"The function is provided for backwards compatibility but may be buggy and is no longer being maintained. "\
"Use clips::udf::nthArgument instead.")]]
